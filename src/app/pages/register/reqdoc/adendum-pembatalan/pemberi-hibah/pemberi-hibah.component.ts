import { Component, OnInit, Output, EventEmitter, OnDestroy, ViewChild, TemplateRef, Input, ChangeDetectorRef, ChangeDetectionStrategy } from '@angular/core';
...
export class PemberiHibahComponent implements OnInit, OnDestroy {
  ...
  constructor(private changeDetectorRef: ChangeDetectorRef ,private router: Router, private windowService: NbWindowService, private http: HttpClient, private refService: RefService, private toastService: NbToastrService, private alertService: AlertService, private route: ActivatedRoute) { }
