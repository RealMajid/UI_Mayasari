...
export class ExecutingAgencyComponent implements OnInit, OnDestroy {
  ...
  constructor(private router: Router, private windowService: NbWindowService, private http: HttpClient, private refService: RefService, private toastService: NbToastrService, private alertService: AlertService, private route: ActivatedRoute) { }
